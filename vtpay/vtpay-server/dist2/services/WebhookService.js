...
class WebhookService {
    ...
    async handleDepositSuccess(event) {
        ...
        await WalletService_1.walletService.creditWallet(virtualAccount.userId.toString(), amountInKobo, 'deposit', data.narration || `Deposit from ${data.senderName}`, data.txnRef, {
            sender: data.sender,
        ...
        logger_1.logger.info(`Successfully credited wallet for user ${virtualAccount.userId} with ${amountInKobo} kobo`);
