...
const HelpMessageSchema = new mongoose_1.Schema({
    userId: {
...
exports.HelpMessage = mongoose_1.default.model('HelpMessage', HelpMessageSchema);
exports.default = exports.HelpMessage;
