...
PayrantService_1.payrantService.transfer = async (payload) => {
...
async function testPayoutSuccess() {
    try {
        ...
        const updatedPayout = await models_1.Payout.findById(payout._id);
...
testPayoutSuccess();
//# sourceMappingURL=test-payout-success.js.map