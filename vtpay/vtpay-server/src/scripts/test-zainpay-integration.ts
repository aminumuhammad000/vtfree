...
async function testZainpayIntegration() {
    ...
    try {
        ...
        if (response.code === '00' && Array.isArray(response.data)) {
            ...
            if (response.data.length > 0) {
                ...
                try {
                    console.log('\n👤 Test 2: Get Zainbox Profile');
                    const profile = await zainpayService.getZainboxProfile(testZainbox.codeName);
                ...
                try {
                    ...
                    const accounts = await zainpayService.getZainboxAccounts(testZainbox.codeName);
                    if (accounts.code === '00') {
                ...
                try {
                    ...
                    const balances = await zainpayService.getZainboxAccountBalances(testZainbox.codeName);
                    if (balances.code === '00') {
                ...
                try {
                    ...
                    const { totalBalance, balances } = await zainpayService.getZainboxBalance(testZainbox.codeName);
                ...
                try {
                    console.log('\n📊 Test 6: Get Zainbox Transactions');
                    const transactions = await zainpayService.getZainboxTransactions(testZainbox.codeName);
                ...
                try {
                    console.log('\n📈 Test 7: Get Payment Summary');
                    const summary = await zainpayService.getZainboxPaymentSummary(testZainbox.codeName);
                    if (summary.code === '00') {
                ...
                try {
                    ...
                    const settlement = await zainpayService.getSettlement(testZainbox.codeName);
                    if (settlement.code === '00' || settlement.code === 200) {
    ...
    try {
        ...
        const nameEnquiry = await zainpayService.nameEnquiry('058', '0123456789');
