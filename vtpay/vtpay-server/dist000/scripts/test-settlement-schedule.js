...
async function testSettlementSchedule() {
    ...
    // Get a test zainbox
    let testZainboxCode = null;
    try {
        console.log('📦 Getting test zainbox...');
        const zainboxes = await ZainpayService_1.zainpayService.listZainboxes();
    ...
    try {
        ...
        const current = await ZainpayService_1.zainpayService.getSettlement(testZainboxCode);
    ...
    try {
        ...
        const t1Result = await ZainpayService_1.zainpayService.createSettlement(t1Payload);
        if (t1Result.code === '00') {
    ...
    try {
        ...
        const verify = await ZainpayService_1.zainpayService.getSettlement(testZainboxCode);
    ...
    try {
        ...
        const t7Result = await ZainpayService_1.zainpayService.createSettlement(t7Payload);
        if (t7Result.code === '00') {
    ...
    try {
        ...
        const t30Result = await ZainpayService_1.zainpayService.createSettlement(t30Payload);
    ...
    try {
        ...
        const deactivateResult = await ZainpayService_1.zainpayService.createSettlement(deactivatePayload);
