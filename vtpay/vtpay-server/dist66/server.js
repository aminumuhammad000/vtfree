...
const startServer = async () => {
    try {
        ...
        try {
            ...
            logger_1.logger.warn('Failed to initialize ZainpayService config (using defaults)', err);
        }
        try {
            ...
            logger_1.logger.warn('Failed to initialize PayrantService config (using defaults)', err);
        }
