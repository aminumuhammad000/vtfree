...
const CommunicationsPage: React.FC = () => {
    console.log('CommunicationsPage rendering');
                        ...
                        <form onSubmit={handleSend} className="space-y-6">
                            ...
                            {recipientType === 'specific' && (
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 h-32"
                                    >
                                        {tenants.map(tenant => (
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 h-64 resize-none"
