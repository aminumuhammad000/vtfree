...
import type { Zainbox } from '../../api/client';
...
const ZainboxPage: React.FC = () => {
    ...
    const fetchZainboxes = async () => {
        try {
            ...
            const mockZainboxes: Zainbox[] = [
                {
                    _id: '1',
                    userId: '1',
                    name: 'ABC Corp Primary',
                    emailNotification: 'finance@abccorp.com',
                    tags: 'production,primary',
                    callbackUrl: 'https://abccorp.com/webhooks/vtpay',
                    codeName: 'ABC_CORP_001',
                ...
                },
                {
                    ...
                    userId: '2',
                    name: 'XYZ Ltd Main',
                    emailNotification: 'payments@xyzltd.com',
                    tags: 'production',
                    callbackUrl: 'https://xyzltd.com/api/webhooks',
                    codeName: 'XYZ_LTD_001',
                ...
                },
                {
                    ...
                    userId: '3',
                    name: 'DEF Inc Test',
                    emailNotification: 'dev@definc.com',
                    tags: 'test,sandbox',
                    callbackUrl: 'https://definc.com/test/webhooks',
                    codeName: 'DEF_INC_TEST',
