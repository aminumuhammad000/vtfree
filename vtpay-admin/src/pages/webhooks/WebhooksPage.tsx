            ...
            const mockWebhooks: Webhook[] = [
                {
                    ...
                    payload: { amount: 50000, reference: 'ZP-DEP-123456' },
                    signature: 'sha256_abc123...',
                    signatureValid: true,
                    dispatchStatus: 'success',
                    dispatchAttempts: 1,
                    createdAt: '2024-12-17T10:02:30Z',
                },
                {
                    _id: '2',
                    source: 'zainpay',
                    ...
                    payload: { amount: 25000, reference: 'ZP-TRF-789012' },
                    signature: 'sha256_def456...',
                    signatureValid: true,
                    dispatchStatus: 'success',
                    dispatchAttempts: 1,
                    createdAt: '2024-12-17T11:17:45Z',
                },
                {
                    _id: '3',
                    source: 'zainpay',
                    ...
                    payload: { amount: 75000, reference: 'ZP-DEP-345678', error: 'Insufficient funds' },
                    signature: 'sha256_ghi789...',
                    signatureValid: true,
                    dispatchStatus: 'failed',
                    dispatchAttempts: 3,
                    createdAt: '2024-12-17T09:32:15Z',
                },
                {
                    _id: '4',
                    source: 'zainpay',
                    eventType: 'transfer.pending',
                    tenantId: '2',
                    tenantName: 'XYZ Ltd',
                    zainboxCode: 'ZBX_XYZ456',
                    payload: { amount: 30000, reference: 'ZP-TRF-567890' },
                    signature: 'sha256_jkl012...',
                    signatureValid: true,
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex justify-between items-start">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">Monitor and manage webhook delivery</p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                {loading ? (
                    <div className="p-8 text-center">
                        ...
                        <p className="mt-2 text-slate-500">Loading webhooks...</p>
                    </div>
                ) : (
                            ...
                            <tbody className="bg-white divide-y divide-slate-200">
                                {filteredWebhooks.map((webhook) => (
                                    <tr key={webhook._id} className="hover:bg-slate-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm text-slate-900">{webhook.tenantName || 'N/A'}</div>
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-900 mt-1">{selectedWebhook.tenantName || 'N/A'}</p>
                                </div>
                                <div>
