...
const ApiKeysPage: React.FC = () => {
    const [apiKeys, setApiKeys] = useState<ApiKey[]>([
        {
            ...
            keyPrefix: 'sk_live_',
            fullKey: 'sk_live_*********************abc123',
            scopes: ['read:transactions', 'write:transfers', 'read:balance'],
            status: 'active',
            usageCount: 12450,
            lastUsed: '2024-12-17T14:30:00Z',
            rateLimit: 1000,
            currentUsage: 847,
        ...
        },
        {
            ...
            tenantId: '2',
            tenantName: 'XYZ Ltd',
            keyName: 'Test Environment',
            keyPrefix: 'sk_test_',
            fullKey: 'sk_test_*********************def456',
            scopes: ['read:transactions', 'read:balance'],
            status: 'active',
            usageCount: 3420,
            lastUsed: '2024-12-17T12:15:00Z',
            rateLimit: 500,
            currentUsage: 234,
        ...
        },
        {
            ...
            keyName: 'Legacy Key',
            keyPrefix: 'sk_live_',
            fullKey: 'sk_live_*********************ghi789',
            scopes: ['read:transactions'],
            status: 'revoked',
            usageCount: 8920,
            lastUsed: '2024-11-30T18:45:00Z',
            rateLimit: 1000,
            currentUsage: 0,
    ...
    const handleCreateKey = (e: React.FormEvent) => {
        ...
        const newKey: ApiKey = {
            ...
            tenantId: 'current_tenant', // In a real app, this would be selected or current context
            tenantName: 'Current Tenant',
            keyName: newKeyData.name,
            keyPrefix: newKeyData.environment === 'live' ? 'sk_live_' : 'sk_test_',
            fullKey: `${newKeyData.environment === 'live' ? 'sk_live_' : 'sk_test_'}*********************${Math.random().toString(36).substr(2, 6)}`,
        ...
        setNewKeyData({ name: '', environment: 'test', scopes: [] });
    };

    const handleRevokeKey = (keyId: string) => {
        if (confirm('Are you sure you want to revoke this API key? This action cannot be undone.')) {
            setApiKeys(apiKeys.map(k => k._id === keyId ? { ...k, status: 'revoked' } : k));
