        ...
        <div className="p-4 lg:p-6 border-b border-slate-700 flex items-center justify-between">
          {(isDesktopOpen || isMobileOpen) && (
            <div className="flex items-center gap-3">
              {app?.logo ? (
                <img src={app.logo} className="w-10 h-10 rounded-lg object-contain bg-white" alt="App Logo" />
              ) : (
              ...
              <div className="overflow-hidden">
                <h1 className="text-lg font-bold bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent truncate">
                  {app?.name || 'VTU'}
                </h1>
