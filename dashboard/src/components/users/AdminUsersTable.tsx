                        ...
                        <form onSubmit={handleCreateAdmin} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 ${errors.first_name
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 ${errors.last_name
                                        ? 'border-red-500 focus:ring-red-500'
                                        : 'border-slate-300 focus:ring-green-500'
                                        }`}
                                    placeholder="Doe"
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className={`flex-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 ${errors.password
                                            ? 'border-red-500 focus:ring-red-500'
                                            : 'border-slate-300 focus:ring-green-500'
                                            }`}
                            ...
                            <tbody className="divide-y divide-slate-200">
                                {admins.map((admin: AdminUser) => (
                                    <tr key={admin._id} className="hover:bg-slate-50 transition">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`px-3 py-1 rounded-full text-sm font-semibold ${admin.status === 'active'
