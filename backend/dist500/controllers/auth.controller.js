...
export class AuthController {
    static async register(req, res) {
        try {
            ...
            const token = jwt.sign({ id: user._id, app_id: user.app_id }, configService.getSync('JWT_SECRET') || config.jwtSecret, { expiresIn: configService.getSync('JWT_EXPIRY') || config.jwtExpiry });
