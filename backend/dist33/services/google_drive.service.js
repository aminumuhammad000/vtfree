...
export class GoogleDriveService {
    ...
    static CREDENTIALS_PATH = path.resolve(__dirname, '../../credentials', 'service_account.json');
    /**
     ...
     */
    static async uploadFile(filePath, fileName, mimeType = 'application/vnd.android.package-archive', shareWithEmail) {
        try {
            ...
            const requestBody = {
                name: fileName,
                parents: [], // Add folder ID here if needed: ['folder_id']
            };
            const media = {
                mimeType: mimeType,
