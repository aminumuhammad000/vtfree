...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { to: '/pages/customers/all', label: 'All Customers' },
      { to: '/pages/customers/by-app', label: 'By App' },
      { to: '/pages/customers/by-user', label: 'By User' },
    ]
  },
  {
      ...
      >
            ...
            <div key={item.label}>
              {item.children ? (
                <>
                  ...
                  {/* Submenu */}
                  {expandedMenus.includes(item.label) && (isDesktopOpen || mobileOpen) && (
        ...
        <div className="p-4 border-t border-green-700/50 space-y-2">
          ...
          >
            ...
            {(isDesktopOpen || mobileOpen) && <span>Logout</span>}
          </button>
          {(isDesktopOpen || mobileOpen) && <p className="text-xs text-green-300/40 px-4">v1.0.0</p>}
        </div>
      </aside>
    </>
  );
