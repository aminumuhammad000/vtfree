        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">User Details</h1>
                        <p className="text-slate-500 text-sm sm:text-base">View and manage user information</p>
                    </div>
                </div>
