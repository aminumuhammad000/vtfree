...
import { FiSearch, FiFilter, FiMoreVertical, FiCheck, FiX, FiLock, FiUnlock } from 'react-icons/fi';
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                    ...
                    <div key={index} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover-lift">
                    ...
                    <table className="w-full">
                        <thead className="bg-slate-50 border-b border-slate-200">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Apps</th>
                                <th className="px-6 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Wallet</th>
                            ...
                            {loading ? (
                                ...
                                users.map((user) => (
                                    <tr key={user._id} className="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`px-2.5 py-1 rounded-full text-xs font-medium ${getKycColor(user.kyc_status)}`}>
